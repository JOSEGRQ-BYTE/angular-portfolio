...
export class WODService 
{
    ...
    public getWODs(): Observable<WOD[]>
    {
        ...
        return this.http.get<WOD[]>(`${environment.wodURL}`, {params:queryParams} )
            .pipe(
                map(wods => {
    ...
    public getLatestWODs(): Observable<WOD[]>
    {
        ...
        return this.http.get<WOD[]>(`${environment.wodURL}/GetLatestWODs`, {params:queryParams} )
            .pipe(
                map(wods => {
                    this.wodsSubject.next(wods as WOD[]);
                    return wods;
